        ...
        if (savedInstanceState == null) {
            ...
            val fragment = TestDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(TestDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(TestDetailFragment.ARG_ITEM_ID))
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, TestListActivity::class.java))
                    true
                }
