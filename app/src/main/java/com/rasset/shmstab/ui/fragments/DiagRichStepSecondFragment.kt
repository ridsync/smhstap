...
class DiagRichStepSecondFragment : BaseFragment() {

    private object Holder { val INSTANCE = DiagRichStepSecondFragment() }
...
//        selectedAdviser = (activity as DiagRichSurveyActivity).selectedAdviser
//        selectedSubCategory = (activity as DiagRichSurveyActivity).selectedSubCategory
