...
class ReqType {
    companion object {
        ...
        const val REQUEST_TYPE_POST_RICHSURVEY_UPLOAD = REQUEST_TYPE_POST_DIAGNOSE_UPDATE + 1
        const val REQUEST_TYPE_POST_SEND_SMS_RICHSURVEY = REQUEST_TYPE_POST_RICHSURVEY_UPLOAD + 1
