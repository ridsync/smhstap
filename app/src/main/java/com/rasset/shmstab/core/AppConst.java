...
public class AppConst {
    ...
    public static final int FRAGMENT_LIKEDYOU = FRAGMENT_USER_LIST +1;
    public static final int FRAGMENT_NOTIFY = FRAGMENT_LIKEDYOU +1;
    public static final int FRAGMENT_VISITOR = FRAGMENT_NOTIFY +1;
    public static final int FRAGMENT_TIME_LINE = FRAGMENT_VISITOR +1;
    public static final int FRAGMENT_CHAT_LIST = FRAGMENT_TIME_LINE +1;
    public static final int FRAGMENT_CHAT_ROOM = 90000;
    public static final int FRAGMENT_PROFILE = FRAGMENT_CHAT_LIST +1;
    public static final int FRAGMENT_PROFILE_ME = FRAGMENT_PROFILE +1;
    public static final int FRAGMENT_OTHER_PROFILE = FRAGMENT_PROFILE_ME +1;
    public static final int FRAGMENT_EDIT_PROFILE = FRAGMENT_OTHER_PROFILE +1;
    public static final int FRAGMENT_EDIT_USERPHOTO = FRAGMENT_EDIT_PROFILE +1;
    public static final int FRAGMENT_EDIT_USERPHOTO_UPDATE = FRAGMENT_EDIT_USERPHOTO +1;
    public static final int FRAGMENT_PHOTOACTIVITY = FRAGMENT_EDIT_USERPHOTO_UPDATE +1;
    public static final int FRAGMENT_PHOTO_DETAIL = FRAGMENT_PHOTOACTIVITY +1;
    public static final int FRAGMENT_PHOTO_FULLSCREENVIEW = FRAGMENT_PHOTO_DETAIL +1;
    public static final int FRAGMENT_PAYMENT_FREEPASS = FRAGMENT_PHOTO_FULLSCREENVIEW +1;
    public static final int FRAGMENT_PAYMENT_HEART = FRAGMENT_PAYMENT_FREEPASS +1;
    public static final int FRAGMENT_SETTING = FRAGMENT_PAYMENT_HEART+1;
    public static final int FRAGMENT_SETTING_TERM_POLICY = FRAGMENT_SETTING +1;
    public static final int FRAGMENT_SETTING_CHANGE_PASSWORD = FRAGMENT_SETTING_TERM_POLICY +1;
    public static final int FRAGMENT_SETTING_NOTIFICATION = FRAGMENT_SETTING_CHANGE_PASSWORD +1;
    public static final int FRAGMENT_REWARD_MAIN = FRAGMENT_SETTING_NOTIFICATION +1;
    public static final int FRAGMENT_REWARD_REQ_DELEIVERY = FRAGMENT_REWARD_MAIN +1;
    public static final int FRAGMENT_SETTING_PERMSETTING = FRAGMENT_REWARD_REQ_DELEIVERY +1;
    public static final int FRAGMENT_EVALUTAION = FRAGMENT_SETTING_PERMSETTING+1;
    public static final int FRAGMENT_ATTENTION_OTHER = FRAGMENT_EVALUTAION+1;
    public static final int FRAGMENT_FAVORITE_DATE = FRAGMENT_ATTENTION_OTHER+1;
    public static final int FRAGMENT_SPOTLIGHT = FRAGMENT_FAVORITE_DATE+1;

    public static final String FRAG_NAME_BOTNAV_MAIN = "FRAG_NAME_BOTNAV_MAIN";
    public static final String FRAG_NAME_USER_LIST = "FRAGMENT_USER_LIST";
    public static final String FRAG_NAME_LIKEDYOU = "FRAGMENT_LIKEDYOU";
    public static final String FRAG_NAME_NOTIFY = "FRAGMENT_NOTIFY";
    public static final String FRAG_NAME_VISITOR = "FRAGMENT_VISITOR";
    public static final String FRAG_NAME_TIME_LINE = "FRAGMENT_TIME_LINE";
    public static final String FRAG_NAME_CHAT_LIST = "FRAGMENT_CHAT_LIST";
    public static final String FRAG_NAME_CHAT_ROOM = "FRAGMENT_CHAT_ROOM";
    public static final String FRAG_NAME_PROFILE = "FRAGMENT_PROFILE";
    public static final String FRAG_NAME_EDIT_PROFILE = "FRAGMENT_EDIT_PROFILE";
    public static final String FRAG_NAME_EDIT_USERPHOTO = "FRAG_NAME_EDIT_USERPHOTO";
    public static final String FRAG_NAME_EDIT_USERPHOTO_UPDATE = "FRAG_NAME_EDIT_USERPHOTO_UPDATE";
    public static final String FRAG_NAME_POSTPHOTO = "FRAGMENT_POSTPHOTO";
    public static final String FRAG_NAME_PHOTOACTIVITY = "FRAGMENT_PHOTOACTIVITY";
    public static final String FRAG_NAME_PHOTO_DETAIL = "FRAGMENT_PHOTO_DETAIL";
    public static final String FRAG_NAME_PHOTO_FULLSCREENVIEW = "FRAGMENT_PHOTO_FULLSCREENVIEW";
    public static final String FRAG_NAME_PAYMENT_FREEPASS = "FRAGMENT_PAYMENT_FREEPASS";
    public static final String FRAG_NAME_PAYMENT_HEART = "FRAGMENT_PAYMENT_HEART";
    public static final String FRAG_NAME_SETTING = "FRAGMENT_SETTING";
    public static final String FRAG_NAME_SETTING_TERM_POLICY = "FRAGMENT_SETTING_TERM_POLICY";
    public static final String FRAG_NAME_SETTING_CHANGE_PASSWORD = "FRAGMENT_SETTING_CHANGE_PASSWORD";
    public static final String FRAG_NAME_SETTING_NOTIFICATION = "FRAGMENT_SETTING_NOTIFICATION";
    public static final String FRAG_NAME_SETTING_PERMISSION = "FRAG_NAME_SETTING_PERMISSION";
    public static final String FRAG_NAME_REWARD_MAIN = "FRAGMENT_REWARD_MAIN";
    public static final String FRAG_NAME_REWARD_REQ_DELEIVERY = "FRAGMENT_REWARD_REQ_DELEIVERY";
    public static final String FRAG_NAME_ATTENTION_OTHER = "FRAG_NAME_ATTENTION_OTHER";
    public static final String FRAG_NAME_SPOTLIGHT = "FRAG_NAME_SPOTLIGHT";
